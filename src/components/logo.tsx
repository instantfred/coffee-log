/**
 * Coffee Log wordmark/brand mark.
 * Line-art coffee cup — inherits `currentColor` so it adapts to any background
 * (dark on light surfaces, white inside the gradient badge).
 */
