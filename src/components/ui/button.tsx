...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 whitespace-nowrap",
  {
    variants: {
      variant: {
        primary:
          "gradient-coffee text-primary-foreground shadow-[var(--shadow-soft)] hover:brightness-105",
        accent:
          "gradient-accent text-accent-foreground shadow-[var(--shadow-soft)] hover:brightness-105",
        outline:
          "border border-border bg-surface/80 text-foreground backdrop-blur-sm hover:bg-surface-muted",
